 ...
 * <p>
 * This implementation <b>allows</b> duplicate elements <code>null</code>
 * references.
 *
 * @author Mario Bobic
 */
public class ArrayIndexedCollection extends Collection {
     ...
     * empty place in this collection). The average complexity of this method is
     * O(1) due to the internal array.
     *
     ...
     * {@link Object#equals equals} method. If the given value is not
     * <code>null</code>, the equality is determined using the equals operator.
     *
    ...
    private void shiftRight(int index) {
        ...
        /* Set the last shifted element's duplicate to null. */
        elements[index] = null;
    }
